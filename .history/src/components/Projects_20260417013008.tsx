...
const projects = [
  ...
  },
  {
    ...
    description:
      "Enterprise dashboard for managing creator profiles and campaigns, ability to view creator profiles, create new campaigns with AI-powered search and real-time filters, aiming to ",
    features: [
