                ...
                <div className="p-6 md:p-8 h-full flex flex-col">
                  ...
                  {project.links.live !== "#" && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="block mb-5 overflow-hidden rounded-xl border border-white/10 hover:border-accent/40 transition-colors"
                      aria-label={`${project.title} live preview`}
                    >
                      <img
                        src={`https://image.thum.io/get/width/1000/noanimate/${project.links.live}`}
              ...
              >
                ...
                {project.links.live !== "#" && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block mb-4 overflow-hidden rounded-lg border border-white/10 hover:border-accent/40 transition-colors"
                    aria-label={`${project.title} live preview`}
                  >
                    <img
                      src={`https://image.thum.io/get/width/800/noanimate/${project.links.live}`}
                      alt={`${project.title} preview`}
                ...
                {project.links.live !== "#" && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block mt-3 text-[11px] text-accent-light hover:text-accent transition-colors"
                  >
                    Open Live Site
                  </a>
                )}
