        ...
        >
          <ul className="space-y-2 text-neutral-200 leading-relaxed list-disc pl-5">
            ...
            <p>
              ...
              that is where most of my work has been focused. Over time, I have
              built and worked on multiple projects and internships, learning
              more by doing than anything else. I usually work with technologies
              like Next.js, MERN Stack, AWS and other modern web tools depending
              on the use case.
            </p>
