...
const projects = [
  ...
  },
  {
    ...
    tech: ["PostgreSQL", "Express.js", "React.js", "Node.js", "CORS"],
    link: "#"
  }
]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <Card key={index} className="bg-background border-border hover:shadow-xl transition-shadow">
              <CardHeader>
              ...
              <CardContent>
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" asChild className="bg-background text-white border-primary/20 hover:bg-primary/10">
