...
export default function SectionWrapper({
  ...
  return (
    <>
      {showDivider && (
        <div className="h-px w-full max-w-[72rem] mx-auto bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent" />
      )}
      ...
      <section id={id} className={`relative w-full py-20 md:py-28 ${className}`}>
        <motion.div
          ...
          className="w-full max-w-[72rem] mx-auto px-6 sm:px-8 lg:px-12"
        >
          {children}
        </motion.div>
      </section>
